...
namespace Caladan.Frontend
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "Ubiq API", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Ubiq API V1");
            });
            ...
            app.UseMvc(routes =>
            {
                ...
                routes.MapRoute(
                   ...
                   template: "exporttransactions/{address?}",
                   defaults: new { controller = "AccountExport", action = "Get" });

                routes.MapRoute(
                  name: "exporttransactionswithtokens",
                  template: "exporttransactionswithtokens/{address?}",
                  defaults: new { controller = "AccountExport", action = "Get", includeTokens = true });
